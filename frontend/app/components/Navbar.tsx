      ...
      <header className="flex items-center justify-between py-4 px-6 bg-white shadow-md rounded-lg">
        ...
        <nav>
          <ul className="flex space-x-6 bg-white rounded-full shadow-md px-6 py-2">
            <li id="nav-overview"
                className={`rounded-full px-4 py-2 ${pathname === "/" ? "bg-[#457B9D] text-white" : "hover:bg-[#A8DADC] hover:text-[#1D3557]"}`}>
              <Link href="/">Overview</Link>
            </li>
            <li id="nav-statistic"
                className={`rounded-full px-4 py-2 ${pathname === "/statistic" ? "bg-[#457B9D] text-white" : "hover:bg-[#A8DADC] hover:text-[#1D3557]"}`}>
              <Link href="/statistic">Statistic</Link>
            </li>
            <li id="nav-prediction"
                className={`rounded-full px-4 py-2 ${pathname === "/prediction" ? "bg-[#457B9D] text-white" : "hover:bg-[#A8DADC] hover:text-[#1D3557]"}`}>
